...
| ----- | -------------------------------------------------------------------------------------------------------------------- | --------------- | ---------- |
| RNF01 | O aplicativo deve apresentar tempo de resposta inferior a 2 segundos nas buscas em aparelhos compatíveis com Android 9.      | Desempenho      | Alta       |
| RNF02 | O sistema deve conter os dados nutricionais dos alimentos armazenados num banco de dados local.                                             | Implementação | Alta       |
